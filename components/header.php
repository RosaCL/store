    <header class="header">
        <section class="flex">
            ...
            <nav class="navbar">
                ...
                $otal_cart_items = $count_total_cart_items->rowCount();

                ?>
                <a href="#" class="cart-icon"><i class="fas fa-shopping-cart"></i><span>(<?=$otal_cart_items;?>)</span></a>
            </nav>
        </section>
    </header>
